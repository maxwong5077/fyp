...
{
  public class ServiceCarouselController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      model.cAROUSEL = db.tbl_carousel_image.Where(x=>x.module == "SERVICE").ToList();
      ...
      try
			{
				...
				var currDB = db.tbl_carousel_image.Where(x => x.module == "SERVICE").ToList();
